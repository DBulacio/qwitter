<template>
  <q-layout view="lHr lpR fFf">
    ...
    <q-drawer show-if-above v-model="rightDrawerOpen" side="right" bordered>
      <!-- el q-input tenía v-model="text" pero en el tutorial no lo usan,
      estaría bueno hacerlo funcionar!
      @todo -->
      <q-input rounded outlined dense placeholder="Search Qwitter" class="q-ma-md">
